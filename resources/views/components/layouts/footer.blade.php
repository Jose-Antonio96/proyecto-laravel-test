...
<footer class="align-center bg-gray-900 md:w-100 lg:h-42 text-white">
    
    <div class="flex justify-between ">
        <div class="relative grid grid-rows-2 grid-flow-col gap-4 m-16">
            <p class="">
          ...
          <img src="images/traveliens2.png" class="md:w-100 lg:h-42 inline-block justify-center" alt="logo"/>
    <div class="m-16">
