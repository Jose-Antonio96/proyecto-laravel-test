...
<div class="container flex justify-center ml-10 p-2 md:p-0 md:translate-x-20 :translate-x-0">
    ...
    <div class="border-2 border-[#f87721] m-10 p-6 grid grid-cols-1 gap-6 shadow-lg rounded-lg bg-[#d53046] shrink-0 ">
      ...
      <div class="text-white">
        Nombre
        <input class="bg-[#183160] rounded flex m-2 content-center" name="name" type="text" value="{{old('name')}}" required>
